...
public class MLEntityEnderman extends EntityMob{
	...
	public void registerRenderers(){
		RenderingRegistry.registerEntityRenderingHandler(MLEntityEnderman.class, new RenderLiving(new ModelEnderman(), 0){protected ResourceLocation getEntityTexture(Entity par1Entity){return new ResourceLocation("textures/mlentity/enderman.png");}});
	}
    ...
    public MLEntityEnderman(World par1World) {
		super(par1World);
        ...
        if (!this.worldObj.isRemote && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"))
        {
            ...
            if (this.func_146080_bZ().getMaterial() == Material.air)
            {
                if (this.rand.nextInt(20) == 0)
                {
                    ...
                    if (MLEntityEnderman.getCarriable(block))
                    {
