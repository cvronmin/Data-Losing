...
public class MLEntitySkeleton extends EntityMob implements IRangedAttackMob{
    private EntityAIArrowAttack aiArrowAttack = new EntityAIArrowAttack(this, 1.0D, 20, 60, 15.0F);
    private EntityAIAttackOnCollide aiAttackOnCollide = new EntityAIAttackOnCollide(this, EntityPlayer.class, 1.2D, false);
	public Object instance;
	public static int mobid = 1012;
	int entityID = mobid;
	public void registerRenderers(){
		RenderingRegistry.registerEntityRenderingHandler(MLEntitySkeleton.class, new RenderLiving(new ModelSkeleton(), 0){protected ResourceLocation getEntityTexture(Entity par1Entity){return new ResourceLocation("textures/mlentity/skeleton.png");}});
	}
	...
	public void load() {
	   ...
	   public MLEntitySkeleton(World par1World)
	    {
	        super(par1World);
