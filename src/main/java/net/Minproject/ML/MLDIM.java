...
public class MLDIM {
	  ...
	  public static int DIMID = 1010;

	  public static MLDIM.BlockTutorialPortal portal = (MLDIM.BlockTutorialPortal)(MLDIM.BlockTutorialPortal)new MLDIM.BlockTutorialPortal().setBlockName("ml_portal").setBlockTextureName("mlportal");
	  public static MLDIM.ModTrigger block;

	  public void load()
	  {
	    GameRegistry.registerBlock(portal, "ml_portal");
	    DimensionManager.registerProviderType(DIMID, MLDIM.WorldProviderMod.class, false);
	  ...
	  static
	  {
	    Block.blockRegistry.addObject(1024, "ml_portal", portal);
	    block = (MLDIM.ModTrigger)(MLDIM.ModTrigger)new MLDIM.ModTrigger().setUnlocalizedName("ml_trigger").setTextureName("mlkey");
	    Item.itemRegistry.addObject(5121, "ml_trigger", block);
	  }

	  public static class WorldProviderMod extends WorldProvider{

	      public void registerWorldChunkManager(){
	          this.worldChunkMgr = new WorldChunkManagerHell(BiomeML.biome, 0.0F);
	      ...
	      public IChunkProvider createChunkGenerator(){
	          return new ChunkProviderModded(this.worldObj, this.worldObj.getSeed()-15463);
	      }
	      ...
	      @Override 
	      protected void generateLightBrightnessTable() {float f = 0.5F;for(int i = 0; i <= 15; ++i) {float f1 = 1.0F - (float) i / 15.0F;this.lightBrightnessTable[i] = (1.0F - f1) / (f1 * 3.0F + 1.0F) * (1.0F - f) + f;}}
	  ...
	  public static class ChunkProviderModded implements IChunkProvider
	  {
	                      ...
	                      for (int l2 = 0; l2 < 8; ++l2)
	                      {
	                          ...
	                          for (int i3 = 0; i3 < 4; ++i3)
	                          {
	                              ...
	                              for (int k3 = 0; k3 < 4; ++k3)
	                              {
	                                  if ((d15 += d16) > 0.0D)
	                                  {
	                                      p_147424_3_[j3 += short1] = BlockDati.block;
	                                  }
	                                  else if (k2 * 8 + l2 < b0)
	                                  {
	                                      p_147424_3_[j3 += short1] = BlockDati.block;
	      ...
	      public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	      {
	              ...
	              && TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, flag, LAKE))
	          {
	              ...
	              (new WorldGenLakes(BlockFormat.block)).generate(this.worldObj, this.rand, k1, l1, i2);
	          }
