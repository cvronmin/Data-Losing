...
public class ContainerTest extends Container{
    private TileEntityTest tileFurnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public ContainerTest(InventoryPlayer par1InventoryPlayer, TileEntityTest par2TileEntityFurnace)
    {
        this.tileFurnace = par2TileEntityFurnace;
        this.addSlotToContainer(new Slot(par2TileEntityFurnace, 0, 69, 27));
        this.addSlotToContainer(new Slot(par2TileEntityFurnace, 1, 30, 27));
        this.addSlotToContainer(new Slot(par2TileEntityFurnace, 2, 125, 28));
        int i;
...
@Override
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (RepairRecipes.repairing().getSmeltingResult(itemstack1) != null)
                {
                ...
                else if (TileEntityTest.isItemFuel(itemstack1))
                {
